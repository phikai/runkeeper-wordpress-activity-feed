...
CURRENTDIR=`pwd`
MAINFILE="runkeeper-wordpress-activity-feed.php" # this should be the name of your main php file in the wordpress plugin
...
if [ -f ".gitmodules" ]
	then
		...
		chmod -R g+x /tmp/runkeeper-activity-feed/trunk/includes/runkeeperAPI/
		chmod -R g+x /tmp/runkeeper-activity-feed/trunk/includes/yaml/
